            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="new-tab" data-toggle="pill" href="#new" role="tab" aria-controls="new" aria-selected="false">
                      <i class="fas fa-clipboard-list alert-primary"></i>
                      <span class="badge badge-primary">12</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="in-progress-tab" data-toggle="pill" href="#in-progress" role="tab" aria-controls="in-progress" aria-selected="false">
                      <i class="fas fa-spinner alert-warning"></i>
                      <span class="badge badge-warning">14</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="ready-tab" data-toggle="pill" href="#ready" role="tab" aria-controls="ready" aria-selected="true">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="alert alert-primary">
                      <div class="row">
                        <div class="col-md-6">
                          <h5><i class="icon fas fa-hashtag"></i> 
                            RT3456
                            <button href="#modal-info" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modal-info">
                      ...
                      <div class="row">
                        <div class="col-7 col-md-7">
                          <button href="#" class="btn btn-sm btn-block btn-primary">Accept</button>
                        </div>
                  ...
                  <div class="tab-pane fade" id="ready" role="tabpanel" aria-labelledby="ready-tab">
                    <h3 class="m-0 text-dark">Ready Orders</h3>
                    <hr>
                    <div class="alert alert-success">
                      ...
                      <div class="row">
                        <div class="col-7 col-md-7">
                          <button href="#" class="btn btn-sm btn-block btn-outline-primary">Assign</button>
                        </div>
                        <div class="col-5 col-md-5">
                          <button href="#" class="btn btn-sm btn-block btn-outline-danger">Reject</button>
                        </div>
