            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="ready-tab" href="{{ route('retailer.orders.ready.index', ['shop' => $shop]) }}" role="tab" aria-controls="ready" aria-selected="true">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  <!--ready-->
                  <div class="tab-pane fade active show" id="ready" role="tabpanel" aria-labelledby="ready-tab">
