                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <retailer-user-add :shop="{{$shop}}"></retailer-user-add>
                        </div>
                    </div>
                    <!-- /.card-header -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @forelse($user->roles as $role)
                                                @if($role->name == App\Models\Role::RETAILER)
                                                    <span class="badge badge-primary">all retailer permissions</span>
                                                @else 
                                                    <p>has some permissions</p>
                                                @endif
                                            @empty 
                                                <p>No roles but has some permissions</p>
                                            @endforelse
                                        </td>

                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm" href="{{ route('retailer.users.edit', ['shop' => $shop->slug, 'user' => $user->slug]) }}" role="button">
                                            ...
                                            <div class="modal fade" id="delete-user-{{$user->id}}" style="display: none;" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{ route('retailer.users.destroy', ['shop' => $shop, 'user' => $user]) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="alert alert-danger alert-dismissible">
                                                                ...
                                                                <br><strong>{{$user->full_name}}</strong>???
