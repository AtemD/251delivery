                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label" for="availability"><small class="text-muted">({{ (bool)$shop->is_available ? 'available' : 'unavailable'}})</small></label>
                            </div>
                            <small class="text-muted">*when your shop is marked as unavailable customers cannot order from your shop temporarily until marked available</small>
                            @error('availability')
