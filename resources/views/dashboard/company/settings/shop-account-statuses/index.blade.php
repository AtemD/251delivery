                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <company-shop-account-status-add></company-shop-account-status-add>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            @forelse($shop_account_statuses as $shop_account_status)
                                <tr>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{ route('company.shop-account-statuses.edit', ['shop_account_status' => $shop_account_status]) }}" role="button">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Delete {{$shop_account_status->name}} Shop Account Status</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">×</span>
                                                        </button>
                                                    </div>
    
                                                    <form role="form" method="POST" action="{{ route('company.shop-account-statuses.destroy', ['shop_account_status' => $shop_account_status]) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger" role="alert">
                                                                ...
                                                                <p class="text-wrap">Are you sure you want to delete this shop account status?</p>
                                                            </div>
                                                        </div>
