                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input" id="order-type-switch-{{$city->id}}" value="{{$city->is_enabled}}" name="toggle-city-status" {{$city->is_enabled === 1 ? 'checked' : ''}}>
                                                                <label class="custom-control-label" for="order-type-switch-{{$city->id}}">City Status</label>
                                                            </div>
                                                        </div>
                                                    </div>
