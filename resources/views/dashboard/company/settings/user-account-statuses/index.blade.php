                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <company-user-account-status-add></company-user-account-status-add>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            @forelse($user_account_statuses as $user_account_status)
                                <tr>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{ route('company.user-account-statuses.edit', ['user_account_status' => $user_account_status]) }}" role="button">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Delete {{$user_account_status->name}} User Account Status</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">×</span>
                                                        </button>
                                                    </div>
    
                                                    <form role="form" method="POST" action="{{ route('company.user-account-statuses.destroy', ['user_account_status' => $user_account_status]) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger" role="alert">
                                                                ...
                                                                <p class="text-wrap">Are you sure you want to delete this user account status?</p>
                                                            </div>
                                                        </div>
