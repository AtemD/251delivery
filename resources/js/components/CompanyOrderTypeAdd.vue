<template>
    <div class="container">
        <div v-if="$can('create order types')">
            ...
            <div class="modal fade" id="add-order-type" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form role="form" @submit.prevent="createOrderType">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input v-model="form.name" type="text" name="name" placeholder="name of order type e.g Delivery"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea v-model="form.description" type="text" rows="3" name="description" placeholder="a short description about the order type"
...
<script>
    export default {
        mounted() {
            console.log('Add order type component mounted.')
        }, 
        data() {
            return {
                form: new Form({
        ...
        methods: {
            createOrderType(){
                this.form.post('/dashboard/company/settings/order-types')
                .then(()=>{

                    $('#add-order-type').modal('hide');
