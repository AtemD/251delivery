<template>
    <div class="container">
        <div v-if="$can('update discounts')">

            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" :data-target="'#edit-discount-'+currentDiscount.id">
                <i class="fas fa-pencil-alt">
                </i>
            </button>

            <div class="modal fade" :id="'edit-discount-'+currentDiscount.id" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form role="form" @submit.prevent="updateDiscount">
...
<script>
    export default {
        ...
        mounted() {
            console.log('Edit Discount component mounted.')
        }, 
        data() {
            return {
                form: new Form({
                    name : this.discount.name,
                    rate: this.discount.discount_rate,
                    rate_type: this.discount.rate_type,
                    shop:  this.shop.id,
                    status: this.discount.is_enabled,
                }),
        ...
        methods: {
            updateDiscount(){
                this.form.put('/dashboard/retailer/shops/'+this.currentShop.slug+'/settings/discounts/'+ this.currentDiscount.id)
                .then(()=>{

                    $('#edit-discount-'+this.currentDiscount.id).modal('hide');
